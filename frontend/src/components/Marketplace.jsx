          ...
          <div key={it.id} className="mkt-card" style={it.id === newId ? { animation: 'mktPop .5s ease' } : undefined}>
            ...
            <div className="mkt-foot">
              <span className="mkt-price">
                ...
                {it.payoutToken === 'USDC' && (
                  <span style={{ marginLeft: 6, fontFamily: 'var(--mono)', fontSize: 8.5, color: '#FF4D94', border: '1px solid rgba(255,0,122,.3)', borderRadius: 5, padding: '1px 5px', whiteSpace: 'nowrap' }} title={es ? 'El pago del vendedor se convierte vía Uniswap' : "Seller's payout is converted via Uniswap"}>🦄 USDC</span>
                )}
              </span>
              {it.status === 'sold'
